...
_PRESERVE_KEYS=(
  ...
  SLIME_AGENT_AGS_START_CONCURRENCY
  SLIME_AGENT_AGS_THREADPOOL_WORKERS
  SLIME_REMOTE_OPENAI_BASE_URL
  SLIME_REMOTE_OPENAI_API_KEY
  SLIME_REMOTE_OPENAI_MODEL
  SLIME_REMOTE_OPENAI_MAX_INFLIGHT
  SLIME_REMOTE_OPENAI_CONNECTOR_LIMIT
  SLIME_REMOTE_OPENAI_KEEPALIVE_SEC
  SLIME_REMOTE_OPENAI_KEEPALIVE_MAX_TOKENS
  SLIME_REMOTE_OPENAI_KEEPALIVE_INFLIGHT
  SLIME_REMOTE_OPENAI_REASONING_EFFORT
  SLIME_REMOTE_OPENAI_THINKING_TYPE
  SLIME_TEACHER_ADAPTER_PUBLIC_URL
  SLIME_TEACHER_ADAPTER_BIND_HOST
  SLIME_TEACHER_ADAPTER_PORT
  SLIME_AGENT_SFT_LOG_DIR
  SLIME_TEACHER_SFT_LOG_DIR
  STEP_GRPO_TEACHER_SFT_MODE
  STEP_GRPO_TEACHER_MAX_STEPS
  STEP_GRPO_TEACHER_TURN_SELECT
  STEP_GRPO_TEACHER_TURN_MAX_PER_TRIAL
  STEP_GRPO_TEACHER_SFT_RESOLVED_ONLY
