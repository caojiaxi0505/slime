...
Useful env:
  ...
  SLIME_CC_GENERATE_GUARD_SEC pipeline guard; default 2700
...
echo "    agent_budget=${SLIME_CC_TIME_BUDGET_SEC}s pipeline_guard=${SLIME_CC_GENERATE_GUARD_SEC}s agent_concurrency=${SLIME_CC_AGENT_CONCURRENCY} eval_concurrency=${SLIME_CC_EVAL_CONCURRENCY}"
echo "    eval_control_concurrency=${SLIME_CC_EVAL_CONTROL_CONCURRENCY} eval_poll=${SLIME_CC_EVAL_POLL_INTERVAL_SEC}s jitter=${SLIME_CC_EVAL_POLL_JITTER_SEC}s grace=${SLIME_CC_EVAL_COMPLETION_GRACE_SEC}s"
